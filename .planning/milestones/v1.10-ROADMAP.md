...
- [x] **Phase 33.1 (INSERTED): Multi-Actor Exact Workspace** - Keep an imported workpiece and generated tool alive in one actor-scoped workspace, support movable tool pose, and unblock cross-model exact measurement.
- [x] **Phase 34: Measurement Commands & Overlay MVP** - Execute supported exact measurements from actor-scoped demo selections and expose typed results plus minimal placement-backed inspection output.
- [x] **Phase 35: Demo Docs & Verification** - Lock the demo measurement workflow through docs, tests, and conditional secondary-surface governance.
...
Plans:
- [x] 33.1-01-PLAN.md — Introduce a multi-actor demo workspace and actor-scoped retained exact-session state
- [x] 33.1-02-PLAN.md — Add additive cross-model exact pairwise support and actor-aware selection bridging
...
Plans:
- [x] 34-01-PLAN.md — Add measurement action runner and typed results panel for supported exact workflows
- [x] 34-02-PLAN.md — Render placement-backed measurement overlay and inspection state in the demo scene
...
Plans:
- [x] 35-01-PLAN.md — Document the measurement demo workflow, supported mappings, and lifecycle constraints
- [x] 35-02-PLAN.md — Add demo verification and conditional governance coverage for measurement integration
...
| 33.1. Multi-Actor Exact Workspace | v1.10 | 2/2 | Complete | 2026-04-21 |
| 34. Measurement Commands & Overlay MVP | v1.10 | 2/2 | Complete | 2026-04-21 |
| 35. Demo Docs & Verification | v1.10 | 2/2 | Complete | 2026-04-21 |
