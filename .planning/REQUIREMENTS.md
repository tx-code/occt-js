...
- [ ] **ADAPT-05**: `@tx-code/occt-core` can accept and normalize the expanded appearance options, forwarding them to the root Wasm carrier without hiding the runtime contract.
